...
function ALERT_BANNER() {
  ...
  <div class="alert-left">
    ...
    <p class="alert-text">Tramitación de subvenciones para aerotermia y fotovoltaica.</p>
  </div>
    ...
    <div class="footer-grid">
      <div>
        ...
        <div class="footer-contact-list">
          <div class="footer-contact-item">${I.map} Carrer de Madrid 15 · Local. 08100 Mollet del Vallès</div>
...
// Service page hero carousels
function SERVICE_HERO_CAROUSELS() {
  document.querySelectorAll('[data-service-carousel]').forEach(function(carousel) {
    var slides = Array.from(carousel.querySelectorAll('.service-hero-slide'));
    var dots = Array.from(carousel.querySelectorAll('.service-hero-dot'));
...
document.addEventListener('DOMContentLoaded', SERVICE_HERO_CAROUSELS);
